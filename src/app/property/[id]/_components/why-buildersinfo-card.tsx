...
export default function WhyBuildersinfoCard() {
    return (
        <Card className="bg-muted/50">
            <CardContent className="p-6 flex flex-col items-center text-center md:flex-row md:items-center md:text-left justify-between gap-6">
                <h3 className="font-bold text-lg whitespace-nowrap">Why choose Buildersinfo?</h3>
                <ul className="grid grid-cols-1 sm:grid-cols-2 gap-x-8 gap-y-2 flex-grow">
                ...
                <Button className="shrink-0 w-full sm:w-auto">Get Free Consultation</Button>
            </CardContent>
        </Card>
    );
}
