            ...
            <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-20 md:py-24">
                <div className="max-w-4xl mx-auto">
                    ...
                    <Section title="License">
                        <p>Unless otherwise stated, Buildersinfo and/or its licensors own the intellectual property rights for all material on Buildersinfo.in. All intellectual property rights are reserved. You may access this from Buildersinfo.in for your own personal use subjected to restrictions set in these terms and conditions.</p>
                        <p>You must not:</p>
                        <ul className="list-disc pl-5 space-y-1">
                            <li>Republish material from Buildersinfo.in</li>
                            <li>Sell, rent or sub-license material from Buildersinfo.in</li>
                            <li>Reproduce, duplicate or copy material from Buildersinfo.in</li>
                            <li>Redistribute content from Buildersinfo.in</li>
                        </ul>
                        <p>Parts of this website offer an opportunity for users to post and exchange opinions and information in certain areas of the website. Buildersinfo does not filter, edit, publish or review Comments prior to their presence on the website. Comments do not reflect the views and opinions of Buildersinfo, its agents and/or affiliates. Comments reflect the views and opinions of the person who post their views and opinions. To the extent permitted by applicable laws, MORDOR REALTY LLP shall not be liable for the Comments or for any liability, damages or expenses caused and/or suffered as a result of any use of and/or posting of and/or appearance of the Comments on this website.</p>
                        <p>Buildersinfo reserves the right to monitor all Comments and to remove any Comments which can be considered inappropriate, offensive or causes breach of these Terms and Conditions.</p>
                        ...
                        <p>You hereby grant Buildersinfo a non-exclusive license to use, reproduce, edit and authorize others to use, reproduce and edit any of your Comments in any and all forms, formats or media.</p>
                    </Section>
                    ...
                    <Section title="Hyperlinking to our Content">
                        ...
                        <ul className="list-disc pl-5 space-y-1">
                            ...
                            <li>the benefit to us from the visibility of the hyperlink compensates the absence of Buildersinfo; and</li>
                        ...
                        <p>If you are one of the organizations listed in paragraph 2 above and are interested in linking to our website, you must inform us by sending an e-mail to Buildersinfo. Please include your name, your organization name, contact information as well as the URL of your site, a list of any URLs from which you intend to link to our Website, and a list of the URLs on our site to which you would like to link. Wait 2-3 weeks for a response.</p>
                        ...
                        <p>No use of Buildersinfo's logo or other artwork will be allowed for linking absent a trademark license agreement.</p>
                    </Section>
                    ...
                    <Section title="Your Privacy">
                        <p>Please read <Link href="/privacy-policy" className="text-primary hover:underline">Privacy Policy</Link></p>
                    </Section>
                    ...
                    <Section title="Cancellation & Refund Policy">
                        <p>All subscriptions are final and no refund will be issues.</p>
                        <p>Due to the nature of the subscription being sold, we cannot issue a refund, prorated or otherwise, for a subscription once it has been paid for.</p>
                        <p>However, your subscription access and/or delivery and accompanied subscriber benefits will continue for the remained of the respective/ current billing period.</p>
                    </Section>
