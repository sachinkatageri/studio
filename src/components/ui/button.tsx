...
const Button = React.forwardRef<HTMLButtonElement, ButtonProps>(
  ({ className, variant, size, asChild = false, ...props }, ref) => {
    ...
    // Check if Check component is a direct child
    const hasCheckIcon = React.Children.toArray(props.children).some(
    ...
    return (
      <Comp
        className={cn(buttonVariants({ variant, size, className }), svgSize)}
        ref={ref}
        {...props}
      />
    )
