...
export default function MapView({ isSidebarOpen, toggleSidebar, onFilterClick, areFiltersApplied, selectedPropertyId, onCloseInfoCard, onMarkerClick, onViewDetails }: MapViewProps) {
  ...
  const mapImages = {
    ...
    hybrid: 'https://images.unsplash.com/photo-1584972191378-d70853fc47fc?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3NDE5ODJ8MHwxfHNlYXJjaHw5fHxnb29nbGUlMjBtYXB8ZW58MHx8fHwxNzY1ODc0NjQyfDA&ixlib=rb-4.1.0&q=80&w=1080',
