...
import { ArrowLeft, Building, LocateFixed, Search } from "lucide-react";
...
const topCities = [
    { name: 'Bangalore' }, { name: 'Chennai' }, { name: 'Delhi' },
    { name: 'Gurgaon' }, { name: 'Hyderabad' }, { name: 'Kolkata' },
    { name: 'Lucknow' }, { name: 'Mumbai' }, { name: 'Navi Mumbai' },
    { name: 'Noida' }, { name: 'Pune' }, { name: 'Thane' },
];
...
export default function CitySelection({ onBack, onCitySelect, onCityReset }: CitySelectionProps) {
    return (
        <div className="flex flex-col h-full bg-card">
            <div className="flex items-center justify-between gap-2 p-4 border-b shrink-0 sticky top-0 z-10 bg-card">
                <div className="flex items-center gap-2">
                    ...
                    <h2 className="text-lg font-semibold">Country/City</h2>
                </div>
            </div>
