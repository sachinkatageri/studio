...
export function LayersSheet({ open, onOpenChange }: LayersSheetProps) {
  ...
  return (
    <Sheet open={open} onOpenChange={onOpenChange}>
      <SheetContent side="bottom" className="h-[85vh] flex flex-col p-0 rounded-t-lg">
        <SheetHeader className="p-4 flex-row items-center justify-between border-b">
          <SheetTitle className="text-xl font-bold">Layers</SheetTitle>
          <SheetClose asChild>
